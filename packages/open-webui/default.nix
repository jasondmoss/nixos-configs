...
in python3Packages.buildPythonApplication rec {
    ...
    # Not force-including the frontend build directory as frontend is managed
    # by the `frontend` derivation above.
    postPatch = ''
substituteInPlace pyproject.toml\
 --replace-fail ', build = "open_webui/frontend"' ""
    ...
    meta = {
        changelog = "https://github.com/open-webui/open-webui/blob/${version}/CHANGELOG.md";
